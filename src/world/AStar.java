...
public class AStar {
	...
	public static java.util.List<Node> findPath(World world, Vector2i start, Vector2i end){
		lastTime =  System.currentTimeMillis();
		java.util.List<Node> openList = new ArrayList<Node>();
		java.util.List<Node> closedList = new ArrayList<Node>();
		...
		while(openList.size() > 0){
			...
			if(current.tile.equals(end)){ //Ponto final
	...
	private static boolean vecInList(java.util.List<Node> list, Vector2i vector) {
